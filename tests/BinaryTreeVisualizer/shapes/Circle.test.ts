 ...
 */
import { CanvasComponent } from "../../../src/Trees/BinaryTreeVisualizer";
...
describe("Circle tests", () => {
  ...
  test("should initialize a proper circle", () => {
  ...
  test("should be able to set coordinates", () => {
    const circle = new Circle(mockValue, mockRadius, mockColorSettings);
  ...
  test("should be able to draw the circle (normal font)", () => {
    const circle = new Circle(mockValue, mockRadius, mockColorSettings);
  ...
  test("should be able to draw the circle (small font)", () => {
  ...
  test("should be able to set color id", () => {
    const circle = new Circle(mockValue, mockRadius, mockColorSettings);
    circle.setCoordinates(mockX, mockY);
  ...
  test("should be able to grow the circle", () => {
    const circle = new Circle(mockValue, mockRadius, mockColorSettings);
    circle.setCoordinates(mockX, mockY);
  ...
  test("should be able to shrink the circle", () => {
    const circle = new Circle(mockValue, mockRadius, mockColorSettings);
    circle.setCoordinates(mockX, mockY);
  ...
  test("should be able to restore the circle (grow)", () => {
    const circle = new Circle(mockValue, mockRadius, mockColorSettings);
    circle.setCoordinates(mockX, mockY);
  ...
  test("should be able to restore the circle (shrink)", () => {
    const circle = new Circle(mockValue, mockRadius, mockColorSettings);
    circle.setCoordinates(mockX, mockY);

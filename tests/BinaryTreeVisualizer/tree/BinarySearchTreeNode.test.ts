import BinarySearchTreeNode from "../../../src/Trees/BinaryTreeVisualizer/tree/BinarySearchTreeNode";

describe("Binary Serach Tree Node tests", () => {
  test("should initialize a proper binary tree node", () => {
  ...
  test("should be able to insert elements properly", () => {
    const mockRootValue = 100;
    const binaryTreeNode = new BinarySearchTreeNode<number>(mockRootValue);
  ...
  test("should be able to delete leaf node", () => {
  ...
  test("should be able to delete node with 1 child", () => {
    const mockRootValue = 12;
    const binaryTreeNode = new BinarySearchTreeNode<number>(mockRootValue);
    const insertArray = [5, 15, 3, 7, 13, 17, 1, 9, 14, 20, 8, 11, 18];
    insertArray.forEach((value) => {
  ...
  test("should be able to delete node with 2 children", () => {
    const mockRootValue = 12;
    const binaryTreeNode = new BinarySearchTreeNode<number>(mockRootValue);
    const insertArray = [5, 15, 3, 7, 13, 17, 1, 9, 14, 20, 8, 11, 18];
    insertArray.forEach((value) => {
  ...
  test("should return deletedNode as undefined if node is not found", () => {
    const mockRootValue = 12;
    const binaryTreeNode = new BinarySearchTreeNode<number>(mockRootValue);
    const insertArray = [5, 15, 3, 7, 13, 17, 1, 9, 14, 20, 8, 11, 18];
    insertArray.forEach((value) => {
  ...
  test("should be able to delete single parent", () => {
    const mockRootValue = 12;
    const binaryTreeNode = new BinarySearchTreeNode<number>(mockRootValue);
  ...
  test("should be able to delete root node when it has 2 children", () => {
    const mockRootValue = 12;
    const binaryTreeNode = new BinarySearchTreeNode<number>(mockRootValue);
    const insertArray = [5, 15, 3, 7, 13, 17, 1, 9, 14, 20, 8, 11, 18];
    insertArray.forEach((value) => {
  ...
  test("should be able to delete root node when it has only left child", () => {
    const mockRootValue = 12;
    const binaryTreeNode = new BinarySearchTreeNode<number>(mockRootValue);
    const insertArray = [5];
    insertArray.forEach((value) => {
